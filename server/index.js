...
const { generateRoomCode, INDIAN_STOCKS, MARKET_SCENARIOS, GAME_CONFIG } = require('./gameTypes');
...
const io = new Server(server, {
  cors: {
    origin: process.env.FRONTEND_URL || process.env.NEXT_PUBLIC_SOCKET_URL || "http://localhost:3000",
    methods: ["GET", "POST"],
    credentials: true
  }
});
